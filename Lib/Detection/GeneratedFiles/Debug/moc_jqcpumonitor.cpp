...
const QMetaObject JQCPUMonitor::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_JQCPUMonitor.data,
      qt_meta_data_JQCPUMonitor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JQCPUMonitor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JQCPUMonitor.stringdata0))
        return static_cast<void*>(const_cast< JQCPUMonitor*>(this));
