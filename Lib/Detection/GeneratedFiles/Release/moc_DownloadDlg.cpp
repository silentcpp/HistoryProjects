...
QT_MOC_LITERAL(8, 71, 5) // "speed"

    },
    "DownloadDlg\0resultSlot\0\0DownloadResult\0"
    "result\0error\0progressSlot\0value\0speed"
};
...
void DownloadDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->progressSlot((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const float(*)>(_a[2]))); break;
        default: ;
        }
    }
}
