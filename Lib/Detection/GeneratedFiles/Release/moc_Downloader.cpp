...
QT_MOC_LITERAL(8, 74, 5), // "speed"
QT_MOC_LITERAL(9, 80, 12), // "finishedSlot"
QT_MOC_LITERAL(10, 93, 14), // "QNetworkReply*"
QT_MOC_LITERAL(11, 108, 5), // "reply"
QT_MOC_LITERAL(12, 114, 13), // "sslErrorsSlot"
QT_MOC_LITERAL(13, 128, 16), // "QList<QSslError>"
QT_MOC_LITERAL(14, 145, 6), // "errors"
QT_MOC_LITERAL(15, 152, 12), // "progressSlot"
QT_MOC_LITERAL(16, 165, 9), // "recvBytes"
QT_MOC_LITERAL(17, 175, 10), // "totalBytes"
QT_MOC_LITERAL(18, 186, 11) // "timeoutSlot"

    },
    "Downloader\0resultSignal\0\0DownloadResult\0"
    "result\0error\0progressSignal\0value\0"
    "speed\0finishedSlot\0QNetworkReply*\0"
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->progressSignal((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const float(*)>(_a[2]))); break;
        ...
        {
            typedef void (Downloader::*_t)(const int & , const float & );
...
// SIGNAL 1
void Downloader::progressSignal(const int & _t1, const float & _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
