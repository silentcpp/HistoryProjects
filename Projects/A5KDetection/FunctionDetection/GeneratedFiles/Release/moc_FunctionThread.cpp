...
struct qt_meta_stringdata_FunctionThread_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FunctionThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FunctionThread_t qt_meta_stringdata_FunctionThread = {
    {
QT_MOC_LITERAL(0, 0, 14) // "FunctionThread"
...
const QMetaObject FunctionThread::staticMetaObject = {
    { &Dt::Avm::staticMetaObject, qt_meta_stringdata_FunctionThread.data,
      qt_meta_data_FunctionThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FunctionThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FunctionThread.stringdata0))
